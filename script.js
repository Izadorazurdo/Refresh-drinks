// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSGT6AAjNkntns-vU98Wfw1UcbZI-_Hi2GGgRfwAjL8s50dsKrAEfH89KYNTULOOuDVZHUD6Z0VkmmP/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSGT6AAjNkntns-vU98Wfw1UcbZI-_Hi2GGgRfwAjL8s50dsKrAEfH89KYNTULOOuDVZHUD6Z0VkmmP/pub?gid=270940200&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSGT6AAjNkntns-vU98Wfw1UcbZI-_Hi2GGgRfwAjL8s50dsKrAEfH89KYNTULOOuDVZHUD6Z0VkmmP/pub?gid=497955488&single=true&output=csv';
    ...
    document.body.innerHTML = `
                <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                    <div class="text-center max-w-md">
                        ...
                        <button onclick="location.reload()" class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600">
                            Tentar novamente
                        </button>
                    </div>
                </div>
